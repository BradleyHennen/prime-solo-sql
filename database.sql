...
INSERT INTO "accounts" ("username", "city", "transactions_completed", "transactions_attempted", "account_balance") VALUES ('bradley', 'minneapolis', 2, 2, 50000000);
...
DELETE FROM "accounts" WHERE "city" = 'miami' OR "city" = 'pheonix' AND "transactions_attempted" < 5;
